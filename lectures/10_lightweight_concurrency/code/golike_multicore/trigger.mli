(** A one-shot signaling primitive for multicore scheduling.

    Same state machine as the unicore trigger, but implemented with
    atomic compare-and-set for multicore safety:
    {v
