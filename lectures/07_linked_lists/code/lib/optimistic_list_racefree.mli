(** Race-free optimistic list interface *)

type 'a t
(** The type of race-free optimistic lists *)
...
(** [contains list item] tests whether [item] is in the list.
    This operation uses locks and validation, and is race-free using atomic operations. *)
